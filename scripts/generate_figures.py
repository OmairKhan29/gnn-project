...
def fig6_gradient_analysis():
    ...
    # Look for full dataset pkl first, fall back to any available
    full_path = "results/gradient_analysis/gradient_analysis_bace_bbbp_clintox_hiv_tox21.pkl"
    legacy_path = "results/gradient_analysis/gradient_analysis.pkl"
    
    if os.path.exists(full_path):
        path = full_path
    elif os.path.exists(legacy_path):
        path = legacy_path
        print("  Warning: using partial gradient analysis (not all datasets)")
    else:
